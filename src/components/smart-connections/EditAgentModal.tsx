...
import { Copy, ExternalLink, Eye, EyeOff, QrCode, User, ChevronDown, ChevronUp } from "lucide-react";
    ...
    return (
      <div className="mt-4 p-4 border rounded-lg bg-gray-50">
        ...
        {selectedTwoFAMethod === "email" && (
          <div className="space-y-3">
            <p className="text-sm text-gray-600">
              Verification codes will be sent to: {agent.portalUser}
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-medium text-gray-900">Customer User</span>
                </div>
                <p className="text-sm text-gray-600">Your company's account</p>
              </div>

              {/* Monto User Card */}
              <div
                className={`p-4 rounded-lg border cursor-pointer transition-all ${
                  selectedAccountType === "Monto"
                    ? "bg-gray-100 border-gray-300"
                    : "bg-white border-gray-200 hover:border-gray-300"
                }`}
                onClick={() => setSelectedAccountType("Monto")}
              >
                <div className="flex items-center gap-3 mb-2">
                  <User className="h-5 w-5 text-gray-600" />
                  <span className="font-medium text-gray-900">Monto User</span>
                </div>
                <p className="text-sm text-gray-600">Dedicated Monto account</p>
              </div>
            </div>
          </div>
