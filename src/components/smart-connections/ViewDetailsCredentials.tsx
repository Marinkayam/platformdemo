...
export function ViewDetailsCredentials({ credentials }: ViewDetailsCredentialsProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="block text-sm font-medium text-[#20222A] mb-1">
          Portal Link
        </label>
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 p-2 bg-gray-50 border rounded text-sm text-[#20222A]">
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 p-2 bg-gray-50 border rounded text-sm font-mono text-[#20222A]">
