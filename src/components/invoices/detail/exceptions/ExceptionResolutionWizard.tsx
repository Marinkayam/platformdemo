    ...
    <div className="p-6 max-w-3xl mx-auto bg-gray-100">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="border-b border-gray-200 p-6">
          <h2 className="text-xl font-semibold mb-1" style={{ color: '#38415F' }}>
            Resolve exception
          </h2>
          <div className="mt-1">
            <span className="rounded-full px-3 py-1 text-xs font-medium text-white" style={{ backgroundColor: '#7B59FF' }}>
              PO
            </span>
          </div>
        </div>
