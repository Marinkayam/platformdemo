        ...
        <Table>
          <TableHeader>
            <TableRow className="h-10">
              <TableHead className="h-10 w-[100px]">Description</TableHead>
              <TableHead className="h-10 w-[100px]">Quantity</TableHead>
              <TableHead className="h-10 w-[100px]">Unit Price</TableHead>
              <TableHead className="h-10 w-[100px]">Total</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {lineItems.map((item) => (
