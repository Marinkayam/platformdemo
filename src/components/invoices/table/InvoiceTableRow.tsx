...
export function InvoiceTableRow({
  ...
  return (
    <TableRow 
      ...
      onClick={handleClick}
    >
      <TableCell className="sticky left-0 z-40 bg-white hover:bg-gray-50 border-r border-gray-200 font-semibold px-4 py-3 w-[250px] min-w-[250px] max-w-[250px] flex-shrink-0 relative transition-colors">
        {isPendingAction && (
