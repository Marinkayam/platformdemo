              ...
              <div key={item.title}>
                <button
                  ...
                  className={cn(
                    ...
                    "hover:bg-gray-100",
                    isSubmenuActive && "bg-purple-100 text-purple-700 font-semibold"
                  )}
                >
                  <div className="flex items-center gap-3">
                    {item.icon && (
                      <item.icon 
                        size={18} 
                        className={isSubmenuActive ? "text-purple-600" : "text-gray-600"} 
                      />
                    )}
                ...
                {!isCollapsed && (
                  <div className={cn(
                    "ml-6 mt-1 space-y-1 transition-all duration-300 overflow-hidden",
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            ...
                            "hover:text-purple-700 hover:bg-gray-50",
                            isSubActive && "text-purple-700 font-semibold bg-purple-50"
                          )}
                        >
                          {subItem.title}
                        </Link>
