  ...
  return (
    <div className="space-y-8 p-8">
      <div className="space-y-2">
        ...
        {/* Last Scan Time - Only show once at the top */}
      ...
      {/* Metrics Grid - Updated styling to match homepage */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="relative overflow-hidden border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white border-[#E6E7EB]">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-1">
              <p className="text-sm text-[#586079]">Monto spotted {buyersCount} unique buyers across all portals</p>
              {recentBuyers.length > 0 && (
                <p className="text-xs text-[#586079]">Latest: {recentBuyers.join(", ")}</p>
              )}
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white border-[#3B82F6]/20">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-2">
              <p className="text-sm text-[#586079]">{portalsCount} portals scanned in the last sweep</p>
        ...
        <Card className="relative overflow-hidden border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white border-[#E6E7EB]">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-2">
              <p className="text-sm text-[#586079]">Top buyers by open invoice value</p>
              <div className="space-y-1">
                {topBuyers.slice(0, 3).map(([buyer, total], idx) => (
                  <div key={buyer} className="text-sm text-[#061237] flex justify-between">
        ...
        <Card className="relative overflow-hidden border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white border-[#E6E7EB]">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-1">
              <p className="text-sm text-[#586079]">Across {openPOsCount} active POs</p>
              {topOpenPO && (
        ...
        <Card className="relative overflow-hidden border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white border-[#E6E7EB]">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-1">
              <p className="text-sm text-[#586079]">Across {openInvoicesCount} records{openInvoicesDueSoon && `, ${openInvoicesDueSoon.length} due soon`}</p>
              {openInvoiceDueSoon && (
        ...
        {/* At Risk Invoices */}
        <Card className="relative overflow-hidden border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-[#FFF5F5] border-[#EF4444]/40">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-medium text-[#EF4444]">At Risk</CardTitle>
          ...
          <CardContent className="space-y-3">
            <div className="text-3xl font-bold text-[#EF4444]">{formatCurrency(atRiskInvoicesTotal)}</div>
            <div className="space-y-1">
              <p className="text-sm text-[#EF4444]">Invoices flagged for immediate attention{atRiskInvoicesCount ? ` (${atRiskInvoicesCount} invoices)` : ''}</p>
              {atRiskPastDueBuyer && (
                <p className="text-xs text-[#EF4444] font-medium">
